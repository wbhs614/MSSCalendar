...
// DateLabel今天的背景色
#define MSS_TodayBackgroundColor MSS_UTILS_COLORRGB(250, 55, 70)
// DateLabel选中时的背景色
#define MSS_SelectBackgroundColor MSS_UTILS_COLORRGB(195, 195, 195)
// DateLabel选中后文字颜色
...
// 节日颜色
#define MSS_HolidayTextColor [UIColor blackColor]
//普通字体颜色
#define MSS_WeekMainTextColor [UIColor blackColor]
// 周末颜色
#define MSS_WeekEndTextColor MSS_UTILS_COLORRGB(170, 171, 172)
//周末背景颜色
#define MSS_WeeKBackGroundColor MSS_UTILS_COLORRGB(251, 252, 253)
// 不可点击文字颜色
