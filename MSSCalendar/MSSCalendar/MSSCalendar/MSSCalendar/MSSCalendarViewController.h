...
@interface MSSCalendarViewController : UIViewController<UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout>
...
@property (copy,nonatomic)void(^selectTimeBlock)(MSSCalendarModel *model);//回调
@end
